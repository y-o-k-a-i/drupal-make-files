...
How patches get handled. It uses [Dave Reid's](https://bitbucket.org/davereid) Project [Drush Patch File](https://bitbucket.org/davereid/drush-patchfile). So download the [Drush Patch File] (https://bitbucket.org/davereid/drush-patchfile/src/e7ffe4ccbb4c7c768788d0c24e6a18835eb35f74/patchfile.drush.inc) to your drush directory `~/.drush` e.g. with `wget` 
